                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        ...
                        <div class="card">
                          <div class="card-body bg-primary">
                            <h3 class="text-center text-white"><a class="text-white" href="<?= base_url('Admin/upload_dokumentasi'); ?>"><i class="far fa-hand-point-right"></i> <?= $judul; ?></a> / Ubah Artikel</h3>
                          </div>
                        </div>
                          ...
                          <div class="col-sm-8">
                            <div class="card">
                              ...
                              <div class="card-body">
                                ...
                                <form method="post" action="<?= base_url('Admin/ubah_artikel_aksi'); ?>" enctype="multipart/form-data">
                                <div class="col-auto">
                                  <label for="a_judul" class="visually-hidden">Judul</label>
                                  <input type="hidden" name="id" value="<?= $artikel['id']; ?>">
                                  <input type="text" name="judul" class="form-control" id="a_judul" value="<?= $artikel['judul']; ?>">
                                ...
                                <div class="col-auto mt-3 mb-3">
                                  ...
                                  <textarea type="text" name="isi" class="form-control" id="a_isi" placeholder="Masukan"><?= $artikel['isi']; ?></textarea>
                                  <?= form_error('isi', '<small class="text-danger">','</small>' ); ?>
                                </div>

                                <center>
                                    <button class="btn btn-success form-control col-4" type="submit">Ubah Artikel</button>
                                </center>
                                </form>
