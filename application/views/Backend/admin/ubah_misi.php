                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        ...
                        <div class="card">
                          <div class="card-body bg-primary">
                            <h3 class="text-center text-white"><a class="text-white" href="<?= base_url('Admin/upload_proker'); ?>"><i class="far fa-hand-point-right"></i> <?= $judul; ?></a> / Ubah Misi</h3>
                          </div>
                        </div>

                        <center>
                          <form method="post" action="<?= base_url('Admin/ubah_misi_aksi'); ?>" enctype="multipart/form-data">
                            ...
                            <div class="card-header">
                              ...
                              <div class="card-body">
                                ...
                                <div class="col-auto mb-2">
                                  ...
                                  <textarea type="text" name="misi" class="form-control" id="misi"><?= $misi['misi']; ?></textarea>
                                </div>

                              </div>
                          </div>

                          <button type="submit" class="btn btn-primary">Ubah Misi</button>
                        </div>
                        </form>
                      </center>
